...
public class GenLevel3Map {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 6. Write core/src/main/resources/maps/map2_part2.map
        List<String> lines = new ArrayList<>();
        lines.add("// Collision grid for map2_part2.png");
        ...
        Path out = Path.of("core/src/main/resources/maps/map2_part2.map");
